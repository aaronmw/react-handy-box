...
export declare type FlexJustification = 'flex-start' | 'flex-end' | 'center' | 'left' | 'right' | 'space-between' | 'space-around' | 'space-evenly' | 'stretch';
export declare type FontSize = 0 | keyof typeof FONT_SIZES;
export declare type FontWeight = 'normal' | 'bold';
export declare type GridSize = keyof typeof GRID_SIZES;
export declare type GridSizeOrLength = GridSize | 'auto' | 'unset' | `${number}px` | `${number}%` | number;
export declare type TextDecoration = keyof typeof TEXT_DECORATIONS;
export declare type TransitionDuration = keyof typeof TRANSITION_DURATIONS | `${number}ms` | `${number}s` | number;
export declare type Overflow = 'auto' | 'clip' | 'hidden' | 'scroll' | 'visible';
...
export declare type WhiteSpace = 'normal' | 'nowrap' | 'pre' | 'pre-wrap' | 'pre-line' | 'break-spaces';
export declare type zIndex = keyof typeof Z_INDEXES | number;
export declare type BoxStyleProps = {
